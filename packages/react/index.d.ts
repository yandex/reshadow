...
/** TODO: improve types for helpers */
export declare function create(styles: object[]): {[key: string]: string};
export declare function map(name: string, ...args: object[]): object;
